                    ...
                    if (n > 0)
                    {
                        ...
                        else
                        {
                            ...
                            for (i = 1; i <= n - 1; i++)
                            {
                                ...
                                t = nk1f*zn/kf;
                                s = s + t;
                                ap.assert((double) (math.maxrealnumber - Math.Abs(t)) > (double) (Math.Abs(s)),
                                    "Overflow in BesselKN");
                                ap.assert(
                                    !((double) (tox) > (double) (1.0) &&
                                      (double) (math.maxrealnumber/tox) < (double) (zmn)), "Overflow in BesselKN");
                                zmn = zmn*tox;
                            }
                            s = s*0.5;
                            t = Math.Abs(s);
                            ap.assert(
                                !((double) (zmn) > (double) (1.0) && (double) (math.maxrealnumber/zmn) < (double) (t)),
                                "Overflow in BesselKN");
                            ap.assert(
                                !((double) (t) > (double) (1.0) && (double) (math.maxrealnumber/t) < (double) (zmn)),
                                "Overflow in BesselKN");
                            ans = s*zmn;
                        }
                    }
        ...
        public class betaf
        {
            ...
            *************************************************************************/
                ...
                double b)
            {
                ...
                sg = 1;
                ap.assert((double) (a) > (double) (0) || (double) (a) != (double) ((int) Math.Floor(a)),
                    "Overflow in Beta");
                ap.assert((double) (b) > (double) (0) || (double) (b) != (double) ((int) Math.Floor(b)),
                    "Overflow in Beta");
                y = a + b;
        ...
        public class ibetaf
        {
            ...
            *************************************************************************/
                ...
                double x)
            {
                ...
                y = y + t + gammafunc.lngamma(a + b, ref sg) - gammafunc.lngamma(a, ref sg) -
                    gammafunc.lngamma(b, ref sg);
                y = y + Math.Log(w/a);
            ...
            *************************************************************************/
                ...
                double y)
            {
                ...
                i = 0;
                ap.assert((double) (y) >= (double) (0) && (double) (y) <= (double) (1),
                ...
                while (true)
                {
                    ...
                    if (mainlooppos == newt)
                    {
                        ...
                        nflg = 1;
                        lgm = gammafunc.lngamma(aaa + bbb, ref s) - gammafunc.lngamma(aaa, ref s) -
                              gammafunc.lngamma(bbb, ref s);
                        i = 0;
            ...
            *************************************************************************/
                ...
                double maxgam)
            {
                ...
                {
                    t = gammafunc.lngamma(a + b, ref sg) - gammafunc.lngamma(a, ref sg) - gammafunc.lngamma(b, ref sg) +
                        u + Math.Log(s);
        ...
        public class binomialdistr
        {
            ...
            *************************************************************************/
                ...
                double p)
            {
                ...
                ap.assert((double) (p) >= (double) (0) && (double) (p) <= (double) (1),
        ...
        public class chisquaredistr
        {
            ...
            *************************************************************************/
                ...
                double x)
            {
                ...
                ap.assert((double) (x) >= (double) (0) && (double) (v) >= (double) (1),
            ...
            *************************************************************************/
                ...
                double y)
            {
                ...
                ap.assert(
                    ((double) (y) >= (double) (0) && (double) (y) <= (double) (1)) && (double) (v) >= (double) (1),
        ...
        public class elliptic
        {
            ...
            *************************************************************************/
            ...
            public static double ellipticintegrale(double m)
            {
                ...
                ap.assert((double) (m) >= (double) (0) && (double) (m) <= (double) (1),
        ...
        public class fdistr
        {
            ...
            *************************************************************************/
                ...
                double y)
            {
                ...
                ap.assert(((a >= 1 && b >= 1) && (double) (y) > (double) (0)) && (double) (y) <= (double) (1),
        ...
        public class poissondistr
        {
            ...
            *************************************************************************/
                ...
                double y)
            {
                ...
                ap.assert((k >= 0 && (double) (y) >= (double) (0)) && (double) (y) < (double) (1),
        ...
        public class studenttdistr
        {
            ...
            *************************************************************************/
                ...
                double p)
            {
                ...
                ap.assert((k > 0 && (double) (p) > (double) (0)) && (double) (p) < (double) (1),
