...
namespace core.MathLab
{
    ...
    public partial class alglib
    {
        ...
        *************************************************************************/
        ...
        public static void spearmanrankcorrelationsignificance(double r, int n, out double bothtails,
    ...
    public partial class alglib
    {
        ...
        *************************************************************************/
        ...
        public static void mannwhitneyutest(double[] x, int n, double[] y, int m, out double bothtails,
            out double lefttail, out double righttail)
        {
            bothtails = 0;
            lefttail = 0;
