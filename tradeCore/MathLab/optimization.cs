    ...
    public partial class alglib
    {
        ...
        *************************************************************************/
        ...
        public class mincgstate
        {
            ...
            public bool needfg
            {
                get { return _innerobj.needfg; }
                set { _innerobj.needfg = value; }
            }
            ...
            public mincg.mincgstate innerobj
            {
        ...
        *************************************************************************/
        ...
        public class mincgreport
        {
            ...
            public int varidx
            {
                get { return _innerobj.varidx; }
                set { _innerobj.varidx = value; }
            }
            ...
            public mincg.mincgreport innerobj
            {
                get { return _innerobj; }
            }
    ...
    public partial class alglib
    {
        ...
        *************************************************************************/
        ...
        public class minbleicstate
        {
            ...
            public minbleic.minbleicstate innerobj
            {
                get { return _innerobj; }
            }
        ...
        *************************************************************************/
        ...
        public class minbleicreport
        {
            ...
            {
                get { return _innerobj.debugeqerr; }
                set { _innerobj.debugeqerr = value; }
            }

            public double debugfs
            {
                get { return _innerobj.debugfs; }
                set { _innerobj.debugfs = value; }
            }

            public double debugff
            {
                get { return _innerobj.debugff; }
                set { _innerobj.debugff = value; }
            }

            public double debugdx
            {
                get { return _innerobj.debugdx; }
                set { _innerobj.debugdx = value; }
            }

            public int debugfeasqpits
            {
                get { return _innerobj.debugfeasqpits; }
                set { _innerobj.debugfeasqpits = value; }
            }

            public int debugfeasgpaits
            {
                get { return _innerobj.debugfeasgpaits; }
                set { _innerobj.debugfeasgpaits = value; }
            }
            ...
            public minbleic.minbleicreport innerobj
            {
                get { return _innerobj; }
            }
        ...
        *************************************************************************/
        ...
        public static void minbleicoptimize(minbleicstate state, ndimensional_func func, ndimensional_rep rep,
            object obj)
        {
            if (func == null)
        ...
        public static void minbleicoptimize(minbleicstate state, ndimensional_grad grad, ndimensional_rep rep,
            object obj)
        {
            if (grad == null)
    ...
    public partial class alglib
    {
        ...
        *************************************************************************/
        ...
        public class minlbfgsstate
        {
            ...
            public minlbfgs.minlbfgsstate innerobj
            {
                get { return _innerobj; }
            }
        ...
        *************************************************************************/
        ...
        public class minlbfgsreport
        {
            ...
            public minlbfgs.minlbfgsreport innerobj
            {
                get { return _innerobj; }
            }
        ...
        *************************************************************************/
        ...
        public static void minlbfgsoptimize(minlbfgsstate state, ndimensional_func func, ndimensional_rep rep,
            object obj)
        {
            if (func == null)
        ...
        public static void minlbfgsoptimize(minlbfgsstate state, ndimensional_grad grad, ndimensional_rep rep,
            object obj)
        {
            if (grad == null)
    ...
    public partial class alglib
    {
        ...
        *************************************************************************/
        ...
        public class minqpstate
        {
            ...
            public minqp.minqpstate innerobj
            {
                get { return _innerobj; }
            }
        ...
        *************************************************************************/
        ...
        public class minqpreport
        {
            ...
            public minqp.minqpreport innerobj
            {
                get { return _innerobj; }
            }
    ...
    public partial class alglib
    {
        ...
        *************************************************************************/
        ...
        public class minlmstate
        {
            ...
            public bool needfgh
            {
                get { return _innerobj.needfgh; }
                set { _innerobj.needfgh = value; }
            }

            public bool needfi
            {
                get { return _innerobj.needfi; }
                set { _innerobj.needfi = value; }
            }
            ...
            public minlm.minlmstate innerobj
            {
                get { return _innerobj; }
            }
        ...
        *************************************************************************/
        ...
        public class minlmreport
        {
            ...
            public int funcidx
            {
                get { return _innerobj.funcidx; }
                set { _innerobj.funcidx = value; }
            }
            ...
            public minlm.minlmreport innerobj
            {
                get { return _innerobj; }
            }
        ...
        *************************************************************************/
        ...
        public static void minlmoptimize(minlmstate state, ndimensional_fvec fvec, ndimensional_jac jac,
            ndimensional_rep rep, object obj)
        {
            if (fvec == null)
                throw new alglibexception("ALGLIB: error in 'minlmoptimize()' (fvec is null)");
            if (jac == null)
        ...
        public static void minlmoptimize(minlmstate state, ndimensional_func func, ndimensional_grad grad,
            ndimensional_hess hess, ndimensional_rep rep, object obj)
        {
            if (func == null)
        ...
        public static void minlmoptimize(minlmstate state, ndimensional_func func, ndimensional_jac jac,
            ndimensional_rep rep, object obj)
        {
            if (func == null)
                throw new alglibexception("ALGLIB: error in 'minlmoptimize()' (func is null)");
        ...
        public static void minlmoptimize(minlmstate state, ndimensional_func func, ndimensional_grad grad,
            ndimensional_jac jac, ndimensional_rep rep, object obj)
        {
            if (func == null)
                throw new alglibexception("ALGLIB: error in 'minlmoptimize()' (func is null)");
            if (grad == null)
    ...
    public partial class alglib
    {
        ...
        *************************************************************************/
        ...
        public class minasastate
        {
            ...
            public mincomp.minasastate innerobj
            {
                get { return _innerobj; }
            }
        ...
        *************************************************************************/
        ...
        public class minasareport
        {
            ...
            {
                get { return _innerobj.activeconstraints; }
                set { _innerobj.activeconstraints = value; }
            }
            ...
            public mincomp.minasareport innerobj
            {
                get { return _innerobj; }
            }
        ...
        public class optserv
        {
            ...
            *************************************************************************/
                ...
                int nslack)
            {
                ...
                for (i = 0; i <= nmain - 1; i++)
                {
                    ap.assert((!havebl[i] || !havebu[i]) || (double) (bl[i]) <= (double) (bu[i]),
            ...
            *************************************************************************/
                ...
                double maxsteplen)
            {
                ...
                for (i = 0; i <= nmain - 1; i++)
                {
                    wasactivated = (double) (x[i]) != (double) (xprev[i]) &&
                                   ((havebndl[i] && (double) (x[i]) == (double) (bndl[i])) ||
                                    (havebndu[i] && (double) (x[i]) == (double) (bndu[i])));
                ...
                for (i = 0; i <= nslack - 1; i++)
                {
                    wasactivated = (double) (x[nmain + i]) != (double) (xprev[nmain + i]) &&
                                   (double) (x[nmain + i]) == (double) (0.0);
            ...
            *************************************************************************/
                ...
                double droptol)
            {
                ...
                for (i = 0; i <= nmain - 1; i++)
                {
                    ...
                    isactive = (havebndl[i] && (double) (x[i]) == (double) (bndl[i])) ||
                               (havebndu[i] && (double) (x[i]) == (double) (bndu[i]));
                ...
                for (i = 0; i <= nslack - 1; i++)
                {
                    ...
                    if ((double) (x[nmain + i]) == (double) (0) &&
                        (double) (Math.Abs(d[nmain + i]*s[nmain + i])) <= (double) (droptol*scalednorm))
                    {
                        d[nmain + i] = 0.0;
                    }
                }
                ...
                int nslack)
            {
                ...
                for (i = 0; i <= nmain - 1; i++)
                {
                    if ((double) (x[i]) != (double) (xprev[i]))
                    {
                        statuschanged = false;
                        if (havebndl[i] &&
                            ((double) (x[i]) == (double) (bndl[i]) || (double) (xprev[i]) == (double) (bndl[i])))
                        {
                            statuschanged = true;
                        }
                        if (havebndu[i] &&
                            ((double) (x[i]) == (double) (bndu[i]) || (double) (xprev[i]) == (double) (bndu[i])))
                        {
                            statuschanged = true;
                        }
                        if (statuschanged)
                ...
                for (i = 0; i <= nslack - 1; i++)
                {
                    if ((double) (x[nmain + i]) != (double) (xprev[nmain + i]) &&
                        ((double) (x[nmain + i]) == (double) (0) || (double) (xprev[nmain + i]) == (double) (0)))
                    {
                        result = result + 1;
                    }
                }
                ...
                ref int gpaits)
            {
                ...
                while (true)
                {
                    ...
                    while (true)
                    {
                        ...
                        calculatestepbound(x, newtonstep, 1.0, bndl, havebndl, bndu, havebndu, nmain, nslack,
                            ref vartofreeze, ref valtofreeze, ref maxsteplen);
                        ...
                        for (i = 0; i <= nsvd - 1; i++)
                        {
                            ...
                            //
                            if ((double) (math.sqr(w[i])) >
                                (double) (math.sqr(w[0])*(nmain + nslack)*math.machineepsilon))
                            {
                        ...
                        postprocessboundedstep(ref xn, x, bndl, havebndl, bndu, havebndu, nmain, nslack, vartofreeze,
                            valtofreeze, v, maxsteplen);
                    ...
                    for (gparuns = 1; gparuns <= k; gparuns++)
                    {
                        ...
                        //
                        calculatestepbound(x, pg, -1.0, bndl, havebndl, bndu, havebndu, nmain, nslack, ref vartofreeze,
                            ref valtofreeze, ref maxsteplen);
                        if (vartofreeze >= 0 && (double) (maxsteplen) == (double) (0))
                        {
                            result = false;
                            return result;
                        ...
                        //
                        werechangesinconstraints = werechangesinconstraints ||
                                                   numberofchangedconstraints(xn, x, bndl, havebndl, bndu, havebndu,
                                                       nmain, nslack) > 0;
                        for (i_ = 0; i_ <= nmain + nslack - 1; i_++)
                        {
                            x[i_] = xn[i_];
            ...
            *************************************************************************/
                ...
                double width)
            {
                ...
                {
                    if ((double) (Math.Abs(h - f)/s) > (double) (0.001) ||
                        (double) (Math.Abs(dh - df)/s) > (double) (0.001))
                    {
                        result = false;
                        return result;
                    }
        ...
        public class mincg
        {
            ...
            *************************************************************************/
                ...
                int maxits)
            {
                ...
                if ((((double) (epsg) == (double) (0) && (double) (epsf) == (double) (0)) &&
                     (double) (epsx) == (double) (0)) && maxits == 0)
                {
                    epsx = 1.0E-6;
                }
                state.epsg = epsg;
            ...
            *************************************************************************/
            ...
            public static bool mincgiteration(mincgstate state)
            {
                ...
                //
                if (
                    !optserv.derivativecheck(state.fm1, state.fp1, state.fm2, state.fp2, state.f, state.g[i],
                        2*state.teststep))
                {
                    state.repvaridx = i;
                ...
                //
                linmin.mcsrch(n, ref state.x, ref state.f, ref state.g, state.d, ref state.stp, state.curstpmax, gtol,
                    ref state.mcinfo, ref state.nfev, ref state.work0, state.lstate, ref state.mcstage);
                lbl_38:
                if (state.mcstage == 0)
                {
                    goto lbl_39;
                ...
                if (!state.innerresetneeded)
                {
                    ...
                    //
                    if ((double) (state.fold - state.f) <=
                        (double) (state.epsf*Math.Max(Math.Abs(state.fold), Math.Max(Math.Abs(state.f), 1.0))))
                    {
                        //
            ...
            *************************************************************************/
                ...
                double teststep)
            {
                ...
                ap.assert((double) (teststep) >= (double) (0),
        ...
        public class minbleic
        {
            ...
            *************************************************************************/
                ...
                double[] bndu)
            {
                ...
                for (i = 0; i <= n - 1; i++)
                {
                    ap.assert(math.isfinite(bndl[i]) || Double.IsNegativeInfinity(bndl[i]),
                        "MinBLEICSetBC: BndL contains NAN or +INF");
                    ap.assert(math.isfinite(bndu[i]) || Double.IsPositiveInfinity(bndu[i]),
                        "MinBLEICSetBC: BndL contains NAN or -INF");
            ...
            *************************************************************************/
                ...
                int k)
            {
                ...
                ap.assert(apserv.apservisfinitematrix(c, k, nmain + 1),
            ...
            *************************************************************************/
            ...
            public static bool minbleiciteration(minbleicstate state)
            {
                ...
                b = optserv.findfeasiblepoint(ref state.tmp0, state.bndleffective, state.hasbndl, state.bndueffective,
                    state.hasbndu, nmain, nslack, state.ceeffective, state.cecnt, state.outerepsi,
                    ref state.repdebugfeasqpits, ref state.repdebugfeasgpaits);
                for (i_ = 0; i_ <= nmain + nslack - 1; i_++)
                {
                ...
                ap.assert(
                    (state.hasbndl[i] && (double) (state.bndloriginal[i]) <= (double) (state.x[i])) || !state.hasbndl[i],
                    "MinBLEICIteration: internal error(State.X is out of bounds)");
                ap.assert(
                    (state.hasbndu[i] && (double) (state.x[i]) <= (double) (state.bnduoriginal[i])) || !state.hasbndu[i],
                    "MinBLEICIteration: internal error(State.X is out of bounds)");
                v = state.x[i];
                ...
                ap.assert(state.prectype == 0 || (double) (state.stpmax) == (double) (0),
                    ...
                    do
                    {
                        ...
                        for (i = 0; i <= nmain - 1; i++)
                        {
                            if (!state.activeconstraints[i])
                            {
                                if (state.hasbndl[i])
                                {
                                    if ((double) (state.cgstate.x[i]) == (double) (state.bndleffective[i]) &&
                                        (double) (state.tmp1[i]) >= (double) (0))
                                    {
                                ...
                                if (state.hasbndu[i])
                                {
                                    if ((double) (state.cgstate.x[i]) == (double) (state.bndueffective[i]) &&
                                        (double) (state.tmp1[i]) <= (double) (0))
                                    {
                                        state.activeconstraints[i] = true;
                        ...
                        for (i = 0; i <= nslack - 1; i++)
                        {
                            ...
                            {
                                if ((double) (state.cgstate.x[nmain + i]) == (double) (0) &&
                                    (double) (state.tmp1[nmain + i]) >= (double) (0))
                                {
                ...
                if (state.cgstate.lsstart)
                {
                    ...
                    for (i = 0; i <= nmain - 1; i++)
                    {
                        if (state.hasbndl[i] && (double) (state.cgstate.d[i]) < (double) (0))
                        {
                            ...
                            state.cgstate.curstpmax = apserv.safeminposrv(vv, -state.cgstate.d[i],
                                state.cgstate.curstpmax);
                    ...
                    for (i = 0; i <= nslack - 1; i++)
                    {
                        if ((double) (state.cgstate.d[nmain + i]) < (double) (0))
                        {
                            ...
                            state.cgstate.curstpmax = apserv.safeminposrv(vv, -state.cgstate.d[nmain + i],
                                state.cgstate.curstpmax);
                            if ((double) (state.cgstate.curstpmax) < (double) (v))
                            {
                ...
                if (state.cgstate.lsend)
                {
                    ...
                    if (state.variabletofreeze >= 0)
                    {
                        ...
                        if (state.cgstate.mcinfo != 5 && state.cgstate.mcinfo != 1)
                        {
                            ...
                            v = Math.Sqrt(v);
                            vv = Math.Sqrt(vv);
                            b = (double) (v) > (double) (state.innerepsg) &&
                                (double) (vv) <= (double) (maxnonmonotoniclen*math.machineepsilon);
                        }
                        else
                        {
                    ...
                    if (b)
                    {
                        ...
                        if (
                            !prepareconstraintmatrix(state, state.tmp0, state.tmp1, ref state.cgstate.x,
                                ref state.cgstate.g))
                        {
                            state.repterminationtype = -3;
                            result = false;
                ...
                if ((double) (state.f) < (double) (state.trimthreshold))
                {
                    ...
                    modifytargetfunction(state, state.tmp1, state.r, vv, ref state.cgstate.f, ref state.cgstate.g,
                        ref state.gnorm, ref state.mpgnorm);
                }
                else
                {
                    //
            ...
            private static void rebuildcexe(minbleicstate state)
            {
                ...
                for (i = 0; i <= state.cecnt - 1; i++)
                {
                    ...
                    for (j = 0; j <= nmain + nslack - 1; j++)
                    {
                        ...
                        {
                            state.cecurrent[i, nmain + nslack] = state.cecurrent[i, nmain + nslack] -
                                                                 state.cecurrent[i, j]*state.constrainedvalues[j];
        ...
        public class minlbfgs
        {
            ...
            *************************************************************************/
                ...
                bool isupper)
            {
                ...
                ap.assert(apserv.isfinitertrmatrix(p, state.n, isupper),
            ...
            *************************************************************************/
            ...
            public static bool minlbfgsiteration(minlbfgsstate state)
            {
                ...
                linmin.linminnormalized(ref state.d, ref state.stp, n);
                linmin.mcsrch(n, ref state.x, ref state.f, ref state.g, state.d, ref state.stp, state.stpmax, gtol,
                    ref mcinfo, ref state.nfev, ref state.work, state.lstate, ref state.mcstage);
                lbl_31:
                if (state.mcstage == 0)
                {
                    goto lbl_32;
        ...
        public class cqmodels
        {
            ...
            *************************************************************************/
                ...
                double alpha)
            {
                ...
                ap.assert(math.isfinite(alpha) && (double) (alpha) >= (double) (0),
                    "CQMSetA: Alpha<0 or is not finite number");
                ap.assert((double) (alpha) == (double) (0) || apserv.isfinitertrmatrix(a, s.n, isupper),
            ...
            *************************************************************************/
                ...
                double tau)
            {
                ...
                ap.assert((double) (tau) == (double) (0) || apserv.isfinitevector(d, s.n),
            ...
            *************************************************************************/
                ...
                double theta)
            {
                ...
                ap.assert((k == 0 || (double) (theta) == (double) (0)) || apserv.apservisfinitematrix(q, k, s.n),
                    "CQMSetQ: Q is not finite matrix");
                ap.assert((k == 0 || (double) (theta) == (double) (0)) || apserv.isfinitevector(r, k),
                    "CQMSetQ: R is not finite vector");
                ap.assert(math.isfinite(theta) && (double) (theta) >= (double) (0),
            ...
            *************************************************************************/
                ...
                double[] x)
            {
                ...
                // ECA
                //
                ap.assert((s.ecakind == 0 || s.ecakind == 1) || (s.ecakind == -1 && nfree == 0),
            ...
            private static bool cqmrebuild(convexquadraticmodel s)
            {
                ...
                if (s.isactivesetchanged || s.ismaintermchanged)
                {
                    ...
                    if ((double) (s.alpha) > (double) (0))
                    {
                        ...
                        {
                            ablas.rmatrixmv(s.nfree, n - s.nfree, s.tq2dense, 0, s.nfree, 0, s.txc, s.nfree, ref s.tq1,
                                0);
                        }
                ...
                // Calculate ECCM
                //
                if (((((s.isactivesetchanged || s.ismaintermchanged) || s.issecondarytermchanged) && s.k > 0) &&
                     (double) (s.theta) > (double) (0)) && nfree > 0)
                {
                    //
            ...
            *************************************************************************/
                ...
                ref double[] tmp)
            {
                ...
                ap.assert((s.ecakind == 0 || s.ecakind == 1) || (s.ecakind == -1 && s.nfree == 0),
        ...
        public class minqp
        {
            ...
            *************************************************************************/
                ...
                bool isupper)
            {
                ...
                ap.assert(apserv.isfinitertrmatrix(a, n, isupper),
            ...
            public static void minqpoptimize(minqpstate state)
            {
                ...
                if (state.algokind == 1)
                {
                    ...
                    if (state.nec + state.nic > 0)
                    {
                        ...
                        if (
                            !optserv.findfeasiblepoint(ref state.tmpfeas, state.workbndl, state.havebndl, state.workbndu,
                                state.havebndu, n, state.nic, state.tmpm0, state.nec + state.nic, 1.0E-6, ref i, ref j))
                        {
                            state.repterminationtype = -3;
                            return;
                        }
                        ...
                        for (i = 0; i <= n - 1; i++)
                        {
                            state.activeb[i] = (state.havebndl[i] &&
                                                (double) (state.xc[i]) == (double) (state.workbndl[i])) ||
                                               (state.havebndu[i] &&
                                                (double) (state.xc[i]) == (double) (state.workbndu[i]));
                        }
                        apserv.bvectorsetlengthatleast(ref state.activelin, state.nec + state.nic);
                        for (i = 0; i <= state.nec + state.nic - 1; i++)
                        {
                            state.activelin[i] = i < state.nec ||
                                                 (double) (state.tmpfeas[n + i - state.nec]) == (double) (0);
                        }
                    }
                    else
                    {
                    ...
                    orthogonalizeactiveconstraints(state.xc, state.activeb, n, state.workcleic, state.activelin,
                        state.nec + state.nic, ref state.activecm, ref state.activecr, ref state.activelincnt);
                    ...
                    while (true)
                    {
                        ...
                        while (true)
                        {
                            ...
                            state.repncholesky = state.repncholesky + 1;
                            if (
                                !minqpconstrainedoptimum(state.a, state.anorm, state.b, state.activeb, state.xc, n,
                                    state.activecm, state.activecr, state.activelincnt, ref state.xn, ref state.tmp0,
                                    ref state.tmp1))
                            {
                                state.repterminationtype = -5;
                                return;
                ...
                ref double[] buf)
            {
                ...
                if (state.activelincnt == 0)
                {
                    ...
                    for (i = 0; i <= n - 1; i++)
                    {
                        ...
                        {
                            if ((state.havebndl[i] && state.havebndu[i]) &&
                                (double) (state.workbndl[i]) == (double) (state.workbndu[i]))
                            {
                                continue;
                            }
                            if ((state.havebndl[i] && (double) (xc[i]) == (double) (state.workbndl[i])) &&
                                (double) (buf[i]) < (double) (0))
                            {
                                result = result + 1;
                                state.activeb[i] = false;
                                continue;
                            }
                            if ((state.havebndu[i] && (double) (xc[i]) == (double) (state.workbndu[i])) &&
                                (double) (buf[i]) > (double) (0))
                            {
                                result = result + 1;
                                state.activeb[i] = false;
                ...
                for (j = 0; j <= n - 1; j++)
                {
                    ...
                    {
                        ap.assert(
                            (state.havebndl[j] && (double) (xc[j]) == (double) (state.workbndl[j])) ||
                            (state.havebndu[j] && (double) (xc[j]) == (double) (state.workbndu[j])),
                            "MinQPDropConstraints: internal error (1)");
                ...
                for (i = 0; i <= state.activelincnt - 1; i++)
                {
                    ...
                    if (nactivebnd < n)
                    {
                        for (j = 0; j <= i - 1; j++)
                        {
                            ...
                            for (i_ = nactivebnd; i_ <= n - 1; i_++)
                            {
                                state.lagrangesystem[i, i_] = state.lagrangesystem[i, i_] -
                                                              v*state.lagrangesystem[j, i_];
                            }
                ...
                while (true)
                {
                    orthogonalizeactiveconstraints(xc, state.activeb, n, state.workcleic, state.activelin,
                        state.nec + state.nic, ref state.activecm, ref state.activecr, ref state.activelincnt);
                    ...
                    for (i = 0; i <= n - 1; i++)
                    {
                        ...
                        {
                            if (((state.havebndl[i] && (double) (xc[i]) == (double) (state.workbndl[i])) &&
                                 (double) (state.lstmp0[i]) < (double) (0)) ||
                                ((state.havebndu[i] && (double) (xc[i]) == (double) (state.workbndu[i])) &&
                                 (double) (state.lstmp0[i]) > (double) (0)))
                            {
            ...
            *************************************************************************/
                ...
                ref double[] buf)
            {
                ...
                for (i = 0; i <= n - 1; i++)
                {
                    if (!state.activeb[i])
                    {
                        ap.assert(!state.havebndl[i] || (double) (xc[i]) >= (double) (state.workbndl[i]),
                            "MinQPBoundedStepAndActivation: internal error - infeasible XC");
                        ap.assert(!state.havebndu[i] || (double) (xc[i]) <= (double) (state.workbndu[i]),
                            "MinQPBoundedStepAndActivation: internal error - infeasible XC");
                ...
                ap.assert(varidx < 0 || linidx < 0, "MinQPBoundedStepAndActivation: internal error (2)");
                ...
                result = optserv.postprocessboundedstep(ref buf, xc, state.workbndl, state.havebndl, state.workbndu,
                    state.havebndu, n, 0, varidx, varval, stplen, stplen);
                if (linidx >= 0)
                {
                    result = result + 1;
                }
                if (result > 0)
                {
                    orthogonalizeactiveconstraints(buf, state.activeb, n, state.workcleic, state.activelin,
                        state.nec + state.nic, ref state.activecm, ref state.activecr, ref state.activelincnt);
                }
                for (i_ = 0; i_ <= n - 1; i_++)
                {
        ...
        public class minlm
        {
            ...
            *************************************************************************/
            ...
            public static bool minlmiteration(minlmstate state)
            {
                ...
                //
                if (
                    !optserv.enforceboundaryconstraints(ref state.xbase, state.bndl, state.havebndl, state.bndu,
                        state.havebndu, n, 0))
                {
                    state.repterminationtype = -3;
                    result = false;
                ...
                ap.assert(
                    (state.havebndl[i] && (double) (state.bndl[i]) <= (double) (state.x[i])) || !state.havebndl[i],
                    "MinLM: internal error(State.X is out of bounds)");
                ap.assert(
                    (state.havebndu[i] && (double) (state.x[i]) <= (double) (state.bndu[i])) || !state.havebndu[i],
                ...
                {
                    if (
                        !optserv.derivativecheck(state.fm1[k], state.gm1[k], state.fp1[k], state.gp1[k], state.fc1[k],
                            state.gc1[k], state.xp1 - state.xm1))
                    {
                        state.repfuncidx = k;
                        state.repvaridx = i;
                        state.repterminationtype = -7;
                ...
                if ((double) (state.lambdav) < (double) (0))
                {
                    ...
                    for (i = 0; i <= n - 1; i++)
                    {
                        state.lambdav = Math.Max(state.lambdav,
                            Math.Abs(state.quadraticmodel[i, i])*math.sqr(state.s[i]));
                    }
                ...
                else
                {
                    ...
                    //
                    ap.assert(state.qprep.terminationtype == -3 || state.qprep.terminationtype == -5,
                ...
                if (state.modelage == 0)
                {
                    if ((double) (Math.Abs(state.f - state.fbase)) <=
                        (double) (state.epsf*Math.Max(1, Math.Max(Math.Abs(state.f), Math.Abs(state.fbase)))))
                    {
                        state.repterminationtype = 1;
                    }
                }
        ...
        public class mincomp
        {
            ...
            *************************************************************************/
            ...
            public static bool minasaiteration(minasastate state)
            {
                ...
                for (i = 0; i <= n - 1; i++)
                {
                    if ((double) (state.xk[i]) == (double) (state.bndl[i]) ||
                        (double) (state.xk[i]) == (double) (state.bndu[i]))
                    {
                        state.ak[i] = 0;
                    }
                    else
                ...
                for (i = 0; i <= n - 1; i++)
                {
                    if ((double) (state.xn[i]) == (double) (state.bndl[i]) ||
                        (double) (state.xn[i]) == (double) (state.bndu[i]))
                    {
                        state.an[i] = 0;
                    }
                    else
                ...
                return result;
                lbl_39:
                if ((double) (state.finit - state.f) >
                    (double) (state.epsf*Math.Max(Math.Abs(state.finit), Math.Max(Math.Abs(state.f), 1.0))))
                {
                    goto lbl_43;
                }
                ...
                linmin.mcsrch(n, ref state.xn, ref state.f, ref state.gc, state.d, ref state.stp, state.stpmax, gtol,
                    ref mcinfo, ref state.nfev, ref state.work, state.lstate, ref state.mcstage);
                lbl_51:
                if (state.mcstage == 0)
                {
                ...
                for (i = 0; i <= n - 1; i++)
                {
                    if ((double) (state.x[i]) == (double) (state.bndl[i]) ||
                        (double) (state.x[i]) == (double) (state.bndu[i]))
                    {
                        state.gc[i] = 0;
                    }
                    else
            ...
            *************************************************************************/
            ...
            private static double asad1norm(minasastate state)
            {
                ...
                {
                    result = result +
                             math.sqr(apserv.boundval(state.x[i] - state.g[i], state.bndl[i], state.bndu[i]) -
                                      state.x[i]);
                }
                result = Math.Sqrt(result);
                return result;
            ...
            *************************************************************************/
            ...
            private static bool asauisempty(minasastate state)
            {
                ...
                for (i = 0; i <= state.n - 1; i++)
                {
                    if ((double) (Math.Abs(state.g[i])) >= (double) (d2) &&
                        (double) (Math.Min(state.x[i] - state.bndl[i], state.bndu[i] - state.x[i])) >= (double) (d32))
                    {
                        result = false;
                        return result;
                    }
