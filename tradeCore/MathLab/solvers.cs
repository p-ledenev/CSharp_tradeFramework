    ...
    public partial class alglib
    {
        ...
        *************************************************************************/
        ...
        public class densesolverreport
        {
            ...
            public densesolver.densesolverreport innerobj
            {
        ...
        *************************************************************************/
        ...
        public class densesolverlsreport
        {
            ...
            public densesolver.densesolverlsreport innerobj
            {
                get { return _innerobj; }
            }
        ...
        *************************************************************************/
        ...
        public static void rmatrixmixedsolvem(double[,] a, double[,] lua, int[] p, int n, double[,] b, int m,
            out int info, out densesolverreport rep, out double[,] x)
        {
            info = 0;
            rep = new densesolverreport();
            x = new double[0, 0];
        ...
        *************************************************************************/
        ...
        public static void hpdmatrixcholeskysolvem(complex[,] cha, int n, bool isupper, complex[,] b, int m,
            out int info, out densesolverreport rep, out complex[,] x)
        {
            info = 0;
            rep = new densesolverreport();
            ...
            *************************************************************************/
                ...
                ref double[,] x)
            {
                ...
                if ((double) (rep.r1) < (double) (rcond.rcondthreshold()) ||
                    (double) (rep.rinf) < (double) (rcond.rcondthreshold()))
                {
                    for (i = 0; i <= n - 1; i++)
                    {
                        for (j = 0; j <= m - 1; j++)
        ...
        public class linlsqr
        {
            ...
            *************************************************************************/
                ...
                int maxits)
            {
                ...
                ap.assert(math.isfinite(epsa) && (double) (epsa) >= (double) (0),
                    "LinLSQRSetCond: EpsA is negative, INF or NAN");
                ap.assert(math.isfinite(epsb) && (double) (epsb) >= (double) (0),
        ...
        public class lincg
        {
            ...
            *************************************************************************/
                ...
                int maxits)
            {
                ...
                ap.assert(math.isfinite(epsf) && (double) (epsf) >= (double) (0),
