        ...
        public class hsschur
        {
            ...
            *************************************************************************/
                ...
                ref int info)
            {
                ...
                ap.assert((zneeded == 0 || zneeded == 1) || zneeded == 2,
                ...
                if ((ns <= 2 || ns > n) || maxb >= n)
                {
                    ...
                    //
                    internalauxschur(wantt, wantz, n, 1, n, ref h, ref wr, ref wi, 1, n, ref z, ref work, ref workv3,
                        ref workc1, ref works1, ref info);
                ...
                while (true)
                {
                    ...
                    for (its = 0; its <= itn; its++)
                    {
                        ...
                        else
                        {
                            ...
                            internalauxschur(false, false, ns, 1, ns, ref s, ref tmpwr, ref tmpwi, 1, ns, ref z,
                                ref work, ref workv3, ref workc1, ref works1, ref ierr);
                            for (p1 = 1; p1 <= ns; p1++)
                            {
                                wr[i - ns + p1] = tmpwr[p1];
                                wi[i - ns + p1] = tmpwi[p1];
                        ...
                        for (j = i - ns + 1; j <= i; j++)
                        {
                            if ((double) (wi[j]) >= (double) (0))
                            {
                                if ((double) (wi[j]) == (double) (0))
                                {
                                    ...
                                    blas.matrixvectormultiply(h, l, l + nv, l, l + nv - 1, false, vv, 1, nv, 1.0, ref v,
                                        1, nv + 1, -wr[j]);
                                    nv = nv + 1;
                                }
                                else
                                {
                                    if ((double) (wi[j]) > (double) (0))
                                    {
                                        ...
                                        blas.matrixvectormultiply(h, l, l + nv, l, l + nv - 1, false, v, 1, nv, 1.0,
                                            ref vv, 1, nv + 1, -(2*wr[j]));
                                        ...
                                        temp = temp*absw*absw;
                                        blas.matrixvectormultiply(h, l, l + nv + 1, l, l + nv, false, vv, 1, nv + 1, 1.0,
                                            ref v, 1, nv + 2, temp);
                                        nv = nv + 2;
                                    }
                                }
                        ...
                        for (k = l; k <= i - 1; k++)
                        {
                            ...
                            //
                            reflections.applyreflectionfromtheright(ref h, tau, v, i1, Math.Min(k + nr, i), k,
                                k + nr - 1, ref work);
                            if (wantz)
                            {
                                //
                    ...
                    //
                    internalauxschur(wantt, wantz, n, l, i, ref h, ref wr, ref wi, 1, n, ref z, ref work, ref workv3,
                        ref workc1, ref works1, ref info);
                    if (info > 0)
                    {
                        return;
                ...
                while (true)
                {
                    ...
                    else
                    {
                        if (l == i - 1)
                        {
                            ...
                            hiim1 = h[i, i - 1];
                            hii = h[i, i];
                            aux2x2schur(ref him1im1, ref him1i, ref hiim1, ref hii, ref wrim1, ref wiim1, ref wri,
                                ref wii, ref cs, ref sn);
                            wr[i - 1] = wrim1;
                            wi[i - 1] = wiim1;
                            wr[i] = wri;
                            wi[i] = wii;
                            ...
                            if (wantt)
                            {
                                ...
                                if (i2 > i)
                                {
                                    workc1[1] = cs;
                                    works1[1] = sn;
                                    rotations.applyrotationsfromtheleft(true, i - 1, i, i + 1, i2, workc1, works1, ref h,
                                        ref work);
                                }
                                workc1[1] = cs;
                                works1[1] = sn;
                                rotations.applyrotationsfromtheright(true, i1, i - 2, i - 1, i, workc1, works1, ref h,
                                    ref work);
                            }
                            if (wantz)
                            {
                                ...
                                workc1[1] = cs;
                                works1[1] = sn;
                                rotations.applyrotationsfromtheright(true, iloz, iloz + nz - 1, i - 1, i, workc1, works1,
                                    ref z, ref work);
                            }
                        }
                    }
        ...
        public class linmin
        {
                ...
                while (true)
                {
                    ...
                    if (stage == 4)
                    {
                            ...
                            (double) (f) > (double) (state.ftest1))
                        {
                            ...
                            //
                            mcstep(ref state.stx, ref state.fxm, ref state.dgxm, ref state.sty, ref state.fym,
                        ...
                        else
                        {
                            ...
                            //           AND TO COMPUTE THE NEW STEP.
                            //
                            mcstep(ref state.stx, ref state.fx, ref state.dgx, ref state.sty, ref state.fy,
            ...
            *************************************************************************/
            ...
            public static bool armijoiteration(armijostate state)
            {
                ...
                // Routine body
                //
                if (((double) (state.stplen) <= (double) (0) || (double) (state.stpmax) < (double) (0)) ||
                    state.fmax < 2)
                {
                    state.info = 0;
                    result = false;
                ...
                int stackptr)
            {
                ...
                if (tasktype == ftbasecffttask || tasktype == ftbaserffttask)
                {
                    ...
                    if (n1 != 1)
                    {
                        ...
                        ftbasegenerateplanrec(n1, ftbasecffttask, plan, ref plansize, ref precomputedsize,
                            ref planarraysize, ref tmpmemsize, ref stackmemsize, stackptr);
                        plan.plan[entryoffset + 6] = plansize;
                        ftbasegenerateplanrec(n2, ftbasecffttask, plan, ref plansize, ref precomputedsize,
                            ref planarraysize, ref tmpmemsize, ref stackmemsize, stackptr);
                        plan.plan[entryoffset + 7] = -1;
                        return;
                    }
